...
# BSE — multiple RSS/API sources in priority order
BSE_RSS_URLS = [
    # Primary: BSE official corporate announcements RSS
    ...
    # feeder.co mirror of BSE (more reliable from external servers)
    "https://feeder.co/discover/5543a3e450/bseindia-com",
    # ET Markets corporate alerts — highly dynamic, 100s per day
    ...
    # Google News corporate filings fallback
    "https://news.google.com/rss/search?q=BSE+NSE+india+board+meeting+results+dividend+corporate+announcement&hl=en-IN&gl=IN&ceid=IN:en",
]
BSE_API_URL = (
...
BSE_GOOGLE_URL = (
    ...
    "?q=BSE+india+board+meeting+results+dividend+announcement+2026"
    "&hl=en-IN&gl=IN&ceid=IN:en"
)
# Legacy single URL kept for compat
BSE_RSS_URL = BSE_RSS_URLS[0]
...
# Multiple NSE RSS fallback sources - tried in order
NSE_RSS_FALLBACKS = [
    # ET Markets corporate alerts - very live, hundreds/day
    "https://economictimes.indiatimes.com/markets/stocks/rssfeeds/2146842.cms",
    # Moneycontrol corporate news
    "https://www.moneycontrol.com/rss/corporatenews.xml",
    # Business Standard corporate
    "https://www.business-standard.com/rss/companies-1021.rss",
    # Google News NSE corporate
    "https://news.google.com/rss/search?q=NSE+india+board+meeting+results+dividend+corporate+announcement+2026&hl=en-IN&gl=IN&ceid=IN:en",
]
