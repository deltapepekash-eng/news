...
INDIA_RSS: List[tuple] = [
    ...
    ("Vaxtex (Google)",
     ["https://news.google.com/rss/search?q=Vaxtex+stock+share&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("CG Power (Google)",
     ["https://news.google.com/rss/search?q=CG+Power+stock+NSE+BSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Reliance Industries (Google)",
     ["https://news.google.com/rss/search?q=Reliance+Industries+stock+RIL&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Baluforge (Google)",
     ["https://news.google.com/rss/search?q=Balu+Forge+Industries+stock&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("DCM Shriram (Google)",
     ["https://news.google.com/rss/search?q=DCM+Shriram+stock+NSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("E2E Networks (Google)",
     ["https://news.google.com/rss/search?q=E2E+Networks+stock+NSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Polymed (Google)",
     ["https://news.google.com/rss/search?q=Polymed+Medical+stock+NSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("IDFC First Bank (Google)",
     ["https://news.google.com/rss/search?q=IDFC+First+Bank+stock+NSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Banking"),
    ("Premier Energies (Google)",
     ["https://news.google.com/rss/search?q=Premier+Energies+stock+NSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Eternal Limited (Google)",
     ["https://news.google.com/rss/search?q=Eternal+Limited+Zomato+stock&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Business Today",
