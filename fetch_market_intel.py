...
INDIA_RSS: List[tuple] = [
    ...
    ("India Economy (Google)",
     ...
     "Economy"),
    # Per-term feeds for zero-coverage stocks
    ("Vaxtex (Google)",
     ["https://news.google.com/rss/search?q=%22Vaxtex%22+OR+%22Vaxtex+Cotfab%22+NSE+BSE+stock&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("CG Power (Google)",
     ["https://news.google.com/rss/search?q=%22CG+Power%22+Industrial+NSE+stock+share&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Reliance Industries (Google)",
     ["https://news.google.com/rss/search?q=%22Reliance+Industries%22+RIL+Q4+results+NSE+2026&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Baluforge (Google)",
     ["https://news.google.com/rss/search?q=%22Balu+Forge%22+NSE+stock+defence+forging&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("DCM Shriram (Google)",
     ["https://news.google.com/rss/search?q=%22DCM+Shriram%22+NSE+stock+results&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("E2E Networks (Google)",
     ["https://news.google.com/rss/search?q=%22E2E+Networks%22+NSE+cloud+stock&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Polymed (Google)",
     ["https://news.google.com/rss/search?q=%22Poly+Medicure%22+OR+%22Polymed%22+NSE+medical+devices&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("IDFC First Bank (Google)",
     ["https://news.google.com/rss/search?q=%22IDFC+First+Bank%22+NSE+results+stock&hl=en-IN&gl=IN&ceid=IN:en"],
     "Banking"),
    ("Premier Energies (Google)",
     ["https://news.google.com/rss/search?q=%22Premier+Energies%22+NSE+solar+stock&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Eternal Limited (Google)",
     ["https://news.google.com/rss/search?q=%22Eternal+Limited%22+OR+%22Zomato%22+NSE+stock+results&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Business Today",
     ["https://www.businesstoday.in/rssfeeds/1282282249.cms"],
     "Markets"),
    ("Zee Business",
     ["https://www.zeebiz.com/latest.rss/feed"],
     "Markets"),
    ("Fortune India",
     ["https://www.fortuneindia.com/rss/story.xml"],
     "Markets"),
    ("Outlook Business",
     ["https://business.outlookindia.com/rss/news"],
     "Markets"),
    ("Business Insider India",
     ["https://www.businessinsider.in/rss.cms"],
     "Markets"),
    ("Bloomberg Quint / BQ Prime",
     ["https://www.bqprime.com/rss/stories.xml"],
     "Markets"),
    ("CNBC TV18 Markets",
     ["https://www.cnbctv18.com/commonfeeds/v1/hin/rss/market.xml",
    ...
    ("ET Corporate",
     ...
     "Corporate"),
    ("ET Banking Finance",
     ["https://economictimes.indiatimes.com/industry/banking/finance/rssfeeds/44786068.cms"],
     "Banking"),
    ("Moneycontrol News",
     ["https://www.moneycontrol.com/rss/MCtopnews.xml"],
     "Markets"),
    # Per-term Google News for zero-coverage stocks
    ("Vaxtex (Google)",
     ["https://news.google.com/rss/search?q=Vaxtex+Cotfab+stock+NSE+BSE+share&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("CG Power (Google)",
     ["https://news.google.com/rss/search?q=%22CG+Power%22+stock+NSE+BSE+share+price&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Reliance Industries (Google)",
     ["https://news.google.com/rss/search?q=%22Reliance+Industries%22+RIL+stock+share+NSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Balu Forge (Google)",
     ["https://news.google.com/rss/search?q=%22Balu+Forge%22+OR+%22Baluforge%22+stock+NSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("DCM Shriram (Google)",
     ["https://news.google.com/rss/search?q=%22DCM+Shriram%22+stock+NSE+share+price&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("E2E Networks (Google)",
     ["https://news.google.com/rss/search?q=%22E2E+Networks%22+stock+NSE+cloud&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Polymed (Google)",
     ["https://news.google.com/rss/search?q=%22Poly+Medicure%22+OR+%22Polymed%22+stock+NSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("IDFC First Bank (Google)",
     ["https://news.google.com/rss/search?q=%22IDFC+First+Bank%22+stock+NSE+share&hl=en-IN&gl=IN&ceid=IN:en"],
     "Banking"),
    ("Premier Energies (Google)",
     ["https://news.google.com/rss/search?q=%22Premier+Energies%22+stock+NSE+solar&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Eternal Limited (Google)",
     ["https://news.google.com/rss/search?q=%22Eternal+Limited%22+OR+%22Zomato%22+stock+NSE&hl=en-IN&gl=IN&ceid=IN:en"],
     "Corporate"),
    ("Multibagger stocks (Google)",
     ["https://news.google.com/rss/search?q=india+multibagger+smallcap+midcap+stock+NSE+2026&hl=en-IN&gl=IN&ceid=IN:en"],
     "Markets"),
    ("Breakout stocks (Google)",
     ["https://news.google.com/rss/search?q=india+breakout+stock+technical+analysis+NSE+2026&hl=en-IN&gl=IN&ceid=IN:en"],
     "Markets"),
    # Broad macro terms with dedicated feeds
    ("India Economy (Google)",
     ["https://news.google.com/rss/search?q=india+economy+GDP+growth+fiscal+policy+2026&hl=en-IN&gl=IN&ceid=IN:en"],
     "Economy"),
    ("Russia Ukraine War markets (Google)",
     ["https://news.google.com/rss/search?q=russia+ukraine+war+oil+markets+india+impact+2026&hl=en&gl=US&ceid=US:en"],
     "Global Economy"),
    ("India Monsoon Agriculture (Google)",
     ["https://news.google.com/rss/search?q=india+monsoon+2026+agriculture+kharif+rabi+economy+RBI&hl=en-IN&gl=IN&ceid=IN:en"],
     "Economy"),
    ("India RBI Policy (Google)",
     ["https://news.google.com/rss/search?q=RBI+India+monetary+policy+repo+rate+inflation+2026&hl=en-IN&gl=IN&ceid=IN:en"],
     "Economy"),
    ("Equitymaster India",
     ["https://www.equitymaster.com/rss/rss-feeds.asp?type=topstories"],
     "Markets"),
    ("Goodreturns India",
     ["https://www.goodreturns.in/rss-feed"],
     "Markets"),
    ("India Infoline",
     ["https://www.indiainfoline.com/rss/news/markets"],
     "Markets"),
    ("Investing.com India",
    ...
    ("Business Standard Companies",
     ["https://www.business-standard.com/rss/companies-1021.rss"],
     "Corporate"),
]
...
WORLD_RSS: List[tuple] = [
    ...
    ("Commodities (Google)",
     ...
     "Commodities"),
    ("US Fed Economy (Google)",
     ["https://news.google.com/rss/search?q=federal+reserve+interest+rates+inflation+US+economy&hl=en&gl=US&ceid=US:en"],
     "Global Economy"),
    ("China Economy (Google)",
     ["https://news.google.com/rss/search?q=china+economy+pmi+trade+yuan+exports&hl=en&gl=US&ceid=US:en"],
     "Global Economy"),
    ("Bloomberg Markets (Google)",
     ["https://news.google.com/rss/search?q=bloomberg+markets+stocks+fed+rates+economy+2026&hl=en&gl=US&ceid=US:en"],
     "Global Markets"),
    ("Russia Ukraine conflict (Google)",
     ["https://news.google.com/rss/search?q=russia+ukraine+war+ceasefire+sanctions+oil+energy+2026&hl=en&gl=US&ceid=US:en"],
     "Global Economy"),
    ("US Stock Market (Google)",
     ["https://news.google.com/rss/search?q=wall+street+dow+jones+nasdaq+S%26P500+stocks+2026&hl=en&gl=US&ceid=US:en"],
     "Global Markets"),
    ("China Trade Economy (Google)",
     ["https://news.google.com/rss/search?q=china+economy+trade+tariffs+yuan+exports+india+2026&hl=en&gl=US&ceid=US:en"],
     "Global Economy"),
]

# ── BSE SOURCES ───────────────────────────────────────────────────────────────
# BSE official RSS (direct from exchange - hundreds of filings/day)
# BSE RSS feeds - company filings only (notices.xml removed - it's exchange notices not company filings)
BSE_RSS_URLS = [
    "https://www.bseindia.com/markets/marketinfo/RSSFeed.aspx?type=corp_ann",
    "https://www.bseindia.com/markets/marketinfo/RSSFeed.aspx?type=board_meetings",
    "https://www.bseindia.com/markets/marketinfo/RSSFeed.aspx?type=results",
    "https://www.bseindia.com/markets/marketinfo/RSSFeed.aspx?type=insider_trading",
    "https://www.bseindia.com/markets/marketinfo/RSSFeed.aspx?type=bulk_deals",
    "https://feeder.co/discover/5543a3e450/bseindia-com",
]
# BSE API covers: Announcements (LODR), Corporate Actions, Financial Results,
# Board Meetings, Insider Trading, Shareholding Pattern (SHP), SAST Updates
BSE_API_CATEGORIES = [
    ("Announcement (LODR)", "-1"),   # All LODR announcements
    ("Financial Results", "6"),
    ("Board Meeting", "7"),
    ("Corporate Action", "9"),
    ("Insider Trading", "5"),
    ("Shareholding Pattern", "13"),
    ("Amalgamation/Merger", "16"),
]
BSE_API_URL = (
...
# BSE-specific fallbacks (intentionally different from NSE fallbacks)
BSE_FALLBACK_URLS = [
    "https://economictimes.indiatimes.com/markets/stocks/rssfeeds/2146842.cms",
    "https://news.google.com/rss/search?q=%22BSE%22+%22board+meeting%22+OR+%22financial+results%22+OR+%22dividend+declared%22+OR+%22corporate+action%22+india+2026&hl=en-IN&gl=IN&ceid=IN:en",
    "https://news.google.com/rss/search?q=BSE+corporate+announcement+%22AGM%22+OR+%22EGM%22+OR+%22rights+issue%22+OR+%22bonus+shares%22+india+2026&hl=en-IN&gl=IN&ceid=IN:en",
]
BSE_GOOGLE_URL = BSE_FALLBACK_URLS[1]
BSE_RSS_URL = BSE_RSS_URLS[0]  # compat
...
# Official NSE RSS feeds from nsearchives.nseindia.com (direct from exchange)
# These are the authoritative NSE filings feeds - hundreds of items/day
NSE_OFFICIAL_RSS = [
    "https://nsearchives.nseindia.com/content/RSS/Corp_Announcement.xml",  # All announcements
    "https://nsearchives.nseindia.com/content/RSS/Financial_Results.xml",  # Quarterly results
    "https://nsearchives.nseindia.com/content/RSS/Board_Meeting.xml",       # Board meetings
    "https://nsearchives.nseindia.com/content/RSS/Corporate_Actions.xml",   # Dividends, splits, bonus
    "https://nsearchives.nseindia.com/content/RSS/Insider_Trading.xml",     # Insider trading
    "https://nsearchives.nseindia.com/content/RSS/Offer_Documents.xml",     # IPO/rights issue
...
# NSE fallback RSS sources if official feeds blocked
NSE_RSS_FALLBACKS = [
    # ET Markets corporate alerts — same reliable source as BSE
    "https://economictimes.indiatimes.com/markets/stocks/rssfeeds/2146842.cms",
    # Moneycontrol corporate news
    "https://www.moneycontrol.com/rss/corporatenews.xml",
    # Business Standard companies
    "https://www.business-standard.com/rss/companies-1021.rss",
    # CNBCTV18 market alerts
    "https://www.cnbctv18.com/commonfeeds/v1/eng/rss/market.xml",
    # NSE-specific Google News
    "https://news.google.com/rss/search?q=%22NSE%22+%22Q4+FY26%22+OR+%22quarterly+results%22+OR+%22board+meeting%22+india+2026&hl=en-IN&gl=IN&ceid=IN:en",
]
NSE_GOOGLE_URL = NSE_RSS_FALLBACKS[4]
...
def get_matched(title: str, summary: str, terms: List[str]) -> List[str]:
    """Case-insensitive term matching. Returns original-case terms that match."""
...
def clean_bse_title(title: str) -> str:
    """Clean BSE title: remove duplicate suffixes like '- BSE', repeated text."""
    title = clean_html_entities(title)
    # Remove trailing " - BSE", " BSE", " - NSE" etc
    title = re.sub(r'\s*[-–]\s*(BSE|NSE)\s*$', '', title, flags=re.IGNORECASE)
    # Remove duplicate halves (e.g. "Foo Bar - Foo Bar")
    parts = title.split(' - ', 1)
    if len(parts) == 2 and parts[0].strip().lower() == parts[1].strip().lower():
        title = parts[0].strip()
    # Truncate long personal names (all caps names like "YASHASWIN NARENDRA SHETH")
    if title.isupper() and len(title.split()) >= 2:
        return ""  # Skip pure uppercase personal name entries
    return title.strip()

def fetch_bse() -> List[Dict]:
    """
    Fetch BSE corporate filings in priority order:
    1. BSE JSON API (most comprehensive - LODR, results, board meetings, etc.)
    2. BSE RSS feeds (corp_ann, board_meetings, results, insider_trading)
    3. BSE-specific fallback news sources
    """
    items: List[Dict] = []
    seen_ids: set = set()

    # ── Try 1: BSE JSON API (best source - direct from exchange) ──
    # Covers: LODR announcements, Financial Results, Board Meetings,
    # Corporate Actions (dividends/bonus/splits), Insider Trading,
    # Shareholding Pattern, Amalgamations
    today    = datetime.now(IST).strftime("%Y%m%d")
    week_ago = (datetime.now(IST) - timedelta(days=14)).strftime("%Y%m%d")
    api_total = 0

    for cat_label, cat_code in BSE_API_CATEGORIES:
        ...
        raw = fetch_url(url, {"Referer": "https://www.bseindia.com/", "Accept": "application/json"})
        if not raw:
            continue
        try:
            data  = json.loads(raw)
            ...
            for row in table[:200]:
                company = clean_html_entities(
                    (row.get("SLONGNAME") or row.get("scrip_name") or "").strip()
                )[:100]
                if not company:
                    company = str(row.get("SCRIP_CD", "Unknown"))
                # Skip all-caps personal names (insider trading disclosers)
                if company.isupper() and len(company.split()) >= 3 and cat_code == "5":
                    continue

                ann_raw  = row.get("SUBCATEGORYNAME") or row.get("CATEGORYNAME") or cat_label
                ann_type = clean_html_entities(ann_raw)[:80]
                headline = clean_html_entities(row.get("HEADLINE") or row.get("SUBJECT") or "")[:250]
                dt_str   = row.get("NEWS_DT") or row.get("DT_TM") or ""
                scrip_cd = row.get("SCRIP_CD", "")
                att      = row.get("ATTACHMENTNAME", "")

                # Use BSE web viewer URL (human-readable) instead of raw PDF
                if scrip_cd:
                    link = f"https://www.bseindia.com/stockinfo/AnnPrint.aspx?scripcd={scrip_cd}&ann_no={row.get('NEWSNO','')}"
                elif att:
                ...
                ts = now_iso()
                for fmt in ("%m/%d/%Y %I:%M:%S %p", "%Y-%m-%dT%H:%M:%S", "%d-%m-%Y %H:%M:%S", "%Y%m%d"):
                    try:
                        dt = datetime.strptime(dt_str.strip()[:19], fmt).replace(tzinfo=IST)
                        ts = (dt.astimezone(timezone.utc).isoformat(timespec="seconds").replace("+00:00","Z"))
                        break
                    except (ValueError, AttributeError):
                        continue

                uid = make_id(company + dt_str + ann_type + scrip_cd)
                if uid in seen_ids:
                    continue
                seen_ids.add(uid)
                batch.append({
                    "id": uid, "company": company,
                    "announcement_type": cat_label,  # Use human-readable category label
                    "detail": headline,
                    "url": link,
                    "published_at": ts,
                    "exchange": "BSE",
            ...
            if batch:
                items.extend(batch)
                api_total += len(batch)
                print(f"    ✓ BSE API [{cat_label}]: {len(batch)} items")
        except Exception as e:
            print(f"    ✗ BSE API [{cat_label}]: {e}")

    if items:
        items.sort(key=lambda x: x.get("published_at",""), reverse=True)
        print(f"    ✓ BSE API total: {api_total} items from {len(BSE_API_CATEGORIES)} categories")
        return items[:500]

    # ── Try 2: BSE RSS feeds (company filings) ────────────────────
    for rss_url in BSE_RSS_URLS:
        raw = fetch_url(rss_url, {"Referer": "https://www.bseindia.com/", "Accept": "application/rss+xml,*/*"})
        if not raw:
            continue
        try:
            text = raw.decode("utf-8", errors="replace").lstrip("\ufeff").strip()
            ...
            for e in root.findall(".//item"):
                title = clean_bse_title(_gtxt(e, "title"))
                link  = _gtxt(e, "link", "guid")
                pub   = _gtxt(e, "pubDate")
                desc  = clean_html_entities(clean(_gtxt(e, "description")))
                if not title:
                    continue
                parts    = title.split(" - ", 1)
                company  = parts[0][:100].strip()
                ann_type = parts[1][:80].strip() if len(parts) > 1 else "Announcement"
                if not company:
                    continue
                ...
                seen_ids.add(uid)
                batch.append({
                    "id": uid, "company": company, "announcement_type": ann_type,
                    "detail": desc[:250], "url": link or "https://www.bseindia.com",
                    "published_at": parse_date(pub), "exchange": "BSE",
                })
            if batch:
                items.extend(batch)
                print(f"    ✓ BSE RSS [{rss_url.split('=')[-1]}]: {len(batch)} items")
        except Exception as e:
            print(f"    ✗ BSE RSS: {e}")

    if items:
        items.sort(key=lambda x: x.get("published_at",""), reverse=True)
        print(f"    ✓ BSE RSS total: {len(items)} items")
        return items[:500]

    # ── Try 3: BSE fallback news sources ──────────────────────────
    print("    → BSE fallback sources")
    for fallback_url in BSE_FALLBACK_URLS:
        for item in fetch_rss("BSE Fallback", [fallback_url], "Corporate", []):
            title = clean_bse_title(item["title"])
            if not title:
                continue
            uid = item["id"]
            if uid in seen_ids:
            ...
            seen_ids.add(uid)
            items.append({
                "id": uid, "company": title[:100], "announcement_type": "Corporate News",
                "detail": clean_html_entities(item.get("summary",""))[:250],
                "url": item["url"], "published_at": item["published_at"], "exchange": "BSE",
            })
...
def fetch_nse() -> List[Dict]:
    """
    Fetch NSE corporate filings.
    NSE official RSS gives .zip/.xbrl attachment URLs - unusable for display.
    Fix: Use NSE API (with session trick) -> ET Markets/MoneyControl RSS fallback
    NSE web viewer URL constructed for human-readable filing access.
    """
    items: List[Dict] = []
    seen_ids: set = set()
    ...
    # ── Try 1: NSE API with session cookie ────────────────────────
    # Ping homepage to establish session, then call API
    ...
    NSE_API_ENDPOINTS = [
        ...
        # Broader endpoint
        f"https://www.nseindia.com/api/corporateAnnouncementData?index=equities&from_date={week_ago}&to_date={today}&type=Company+Update",
        f"https://www.nseindia.com/api/corporateAnnouncementData?index=equities&from_date={week_ago}&to_date={today}&type=Board+Meeting",
        f"https://www.nseindia.com/api/corporateAnnouncementData?index=equities&from_date={week_ago}&to_date={today}&type=Financial+Results",
    ]
    for api_url in NSE_API_ENDPOINTS:
        ...
        try:
            ...
            for row in records[:MAX_ITEMS]:
                company  = clean_html_entities(
                    (row.get("sm_name") or row.get("symbol") or "Unknown").strip()
                )[:100]
                ann_type = clean_html_entities(
                    (row.get("desc") or row.get("subject") or "Announcement").strip()
                )[:80]
                detail   = clean_html_entities(
                    (row.get("attchmntText") or row.get("exc_dissem") or "").strip()
                )[:250]
                ...
                # Use NSE web viewer instead of raw .zip/.xbrl
                if symbol:
                ...
                uid = make_id(company + dt_str + ann_type)
                if uid in seen_ids:
                    continue
                seen_ids.add(uid)
                batch.append({
                    "id": uid, "company": company, "announcement_type": ann_type,
                    "detail": detail, "url": link, "published_at": ts, "exchange": "NSE",
                })
            if batch:
                items.extend(batch)
                print(f"    ✓ NSE API: {len(batch)} items")
        except Exception as e:
            print(f"    ✗ NSE API: {e}")
    ...
    # ── Try 2: NSE official RSS (fix .zip/.xbrl URLs → web viewer) ──
    print("    → NSE official RSS")
    for rss_url in NSE_OFFICIAL_RSS:
        raw = fetch_url(rss_url, {"Referer": "https://www.nseindia.com/", "Accept": "application/rss+xml,*/*"})
        if not raw:
            continue
        try:
            text = raw.decode("utf-8", errors="replace").lstrip("\ufeff").strip()
            ...
            batch = []
            for e in root.findall(".//item"):
                raw_title = clean_html_entities(_gtxt(e, "title"))
                link  = _gtxt(e, "link", "guid") or ""
                pub   = _gtxt(e, "pubDate")
                desc  = clean_html_entities(clean(_gtxt(e, "description")))
                ...
                # NSE RSS title format: "COMPANY NAME : Announcement Type"
                # Fix URLs: replace .zip/.xbrl with NSE web filings page
                if link.endswith(".zip") or link.endswith(".xml") or "xbrl" in link.lower():
                    link = "https://www.nseindia.com/companies-listing/corporate-filings-announcements"

                # Parse company and type from title
                if " : " in raw_title:
                    parts = raw_title.split(" : ", 1)
                    company  = clean_bse_title(parts[0])[:100]
                    ann_type = parts[1][:80].strip()
                elif " - " in raw_title:
                    parts = raw_title.split(" - ", 1)
                    company  = clean_bse_title(parts[0])[:100]
                    ann_type = parts[1][:80].strip()
                else:
                    company  = clean_bse_title(raw_title)[:100]
                    ann_type = "Announcement"

                if not company:
                    continue

                uid = make_id(raw_title + link)
                if uid in seen_ids:
                    continue
                seen_ids.add(uid)
                batch.append({
                    "id": uid, "company": company, "announcement_type": ann_type,
                    "detail": desc[:250], "url": link,
                    "published_at": parse_date(pub), "exchange": "NSE",
                })
            if batch:
                items.extend(batch)
                print(f"    ✓ NSE RSS [{rss_url.split('/')[-1]}]: {len(batch)} items")
        except Exception as e:
            print(f"    ✗ NSE RSS [{rss_url.split('/')[-1]}]: {e}")

    if items:
        items.sort(key=lambda x: x.get("published_at",""), reverse=True)
        print(f"    ✓ NSE RSS total: {len(items)} items")
        return items[:500]

    # ── Try 3: Fallback to ET Markets + MoneyControl ──────────────
    print("    → NSE RSS fallbacks")
    for rss_url in NSE_RSS_FALLBACKS:
        batch = []
        for item in fetch_rss("NSE Fallback", [rss_url], "Corporate", []):
            title = clean_bse_title(item["title"])
            if not title or item["id"] in seen_ids:
                continue
            seen_ids.add(item["id"])
            batch.append({
                "id": item["id"], "company": title[:100], "announcement_type": "Corporate News",
                "detail": clean_html_entities(item.get("summary",""))[:250],
                "url": item["url"], "published_at": item["published_at"], "exchange": "NSE",
            })
        if batch:
            items.extend(batch)
            print(f"    ✓ NSE fallback [{rss_url.split('/')[2][:20]}]: {len(batch)} items")

    items.sort(key=lambda x: x.get("published_at",""), reverse=True)
    print(f"    ✓ NSE total: {len(items)} items")
    return items[:300]
...
def fetch_search_feed(terms: List[str], india_items: List[Dict], world_items: List[Dict]) -> List[Dict]:
    ...
    # Group items by which terms they match — case-insensitive
    term_buckets: dict = {t: [] for t in terms}
    term_lower_map = {t.lower(): t for t in terms}  # lowercase → original case
    for item in all_items:
        matched = item.get("matched_terms", [])
        for mt in matched:
            orig = term_lower_map.get(mt.lower())
            if orig:
                term_buckets[orig].append(item)
...
def main_v22():
    ...
    for name, urls, cat in INDIA_RSS:
        ...
        time.sleep(0.3)
    india_items = merge(existing.get("india_news", []), new_india, cap=1500)
    print(f"  India: {len(new_india)} new → {len(india_items)} stored\n")
    ...
    for name, urls, cat in WORLD_RSS:
        ...
        time.sleep(0.3)
    world_items = merge(existing.get("world_news", []), new_world, cap=1500)
    print(f"  World: {len(new_world)} new → {len(world_items)} stored\n")

    # ── Per-term booster: ensure every term has at least 10 articles ─────────
    print("Boosting zero/low-coverage terms…")
    all_pool = india_items + world_items
    boosted_items: List[Dict] = []
    for term in terms:
        coverage = sum(1 for x in all_pool
                       if term.lower() in (x.get("title","") + x.get("summary","")).lower())
        if coverage < 10:
            gn_url = (f"https://news.google.com/rss/search"
                      f"?q={urllib.parse.quote(term)}+india+stock+market"
                      f"&hl=en-IN&gl=IN&ceid=IN:en")
            extra = fetch_rss(f"GN:{term}", [gn_url], "Markets", terms)
            if extra:
                boosted_items.extend(extra)
                print(f"  Boosted '{term}': +{len(extra)} items")
            time.sleep(0.2)
    if boosted_items:
        india_items = merge(india_items, boosted_items, cap=1500)
        print(f"  After boost: India pool = {len(india_items)}\n")
    ...
    fresh_bse = fetch_bse()
    if fresh_bse:
        # Got live data — merge with only recent clean existing items (2026+)
        clean_old_bse = [x for x in existing.get("bse", [])
                         if x.get("published_at","") >= "2026-01-01"
                         and not any(p in x.get("company","").lower()
                                     for p in [" - bse", "corporates", "get quote",
                                               "ref no:", "nagesh", "yashaswin", "&nbsp"])]
        bse_items = merge(clean_old_bse, fresh_bse, cap=500)
    else:
        # No live fetch — use only clean recent existing data
        bse_items = [x for x in existing.get("bse", [])
                     if x.get("published_at","") >= "2026-01-01"
                     and not any(p in x.get("company","").lower()
                                 for p in [" - bse", "corporates", "get quote",
                                           "ref no:", "nagesh", "yashaswin", "&nbsp"])][:300]
    print(f"  BSE: {len(bse_items)} stored\n")

    print("Fetching NSE…")
    fresh_nse = fetch_nse()
    if fresh_nse:
        clean_old_nse = [x for x in existing.get("nse", [])
                         if x.get("published_at","") >= "2026-01-01"
                         and not any(p in x.get("company","").lower()
                                     for p in ["share price today", "stock price live",
                                               "stocks to watch", "ipo allotment",
                                               "q3 results", "q4 results"])]
        nse_items = merge(clean_old_nse, fresh_nse, cap=500)
    else:
        nse_items = [x for x in existing.get("nse", [])
                     if x.get("published_at","") >= "2026-01-01"
                     and not any(p in x.get("company","").lower()
                                 for p in ["share price today", "stock price live",
                                           "stocks to watch", "ipo allotment"])][:300]
