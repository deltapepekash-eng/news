...
INDIA_RSS: List[tuple] = [
    ...
    ("Eternal Limited (Google)",
     ...
     "Corporate"),
    ("Smallcap India (Google)",
     ["https://news.google.com/rss/search?q=india+smallcap+midcap+stock+multibagger&hl=en-IN&gl=IN&ceid=IN:en"],
     "Markets"),
    ("FII DII flows (Google)",
     ["https://news.google.com/rss/search?q=FII+DII+flows+india+stock+market&hl=en-IN&gl=IN&ceid=IN:en"],
     "Markets"),
    ("India Inflation GDP (Google)",
     ["https://news.google.com/rss/search?q=india+inflation+GDP+CPI+RBI+rate&hl=en-IN&gl=IN&ceid=IN:en"],
     "Economy"),
    ("India IPO (Google)",
     ["https://news.google.com/rss/search?q=india+IPO+NSE+BSE+listing+2026&hl=en-IN&gl=IN&ceid=IN:en"],
     "IPO"),
    ("India Defence Sector (Google)",
     ["https://news.google.com/rss/search?q=india+defence+sector+stocks+HAL+BEL&hl=en-IN&gl=IN&ceid=IN:en"],
     "Sector"),
    ("India Pharma Sector (Google)",
     ["https://news.google.com/rss/search?q=india+pharma+sector+stocks+Sun+Cipla+DrReddy&hl=en-IN&gl=IN&ceid=IN:en"],
     "Sector"),
    ("India Auto Sector (Google)",
     ["https://news.google.com/rss/search?q=india+auto+sector+stocks+Maruti+Tata+Motors&hl=en-IN&gl=IN&ceid=IN:en"],
     "Sector"),
    ("Monsoon India (Google)",
     ["https://news.google.com/rss/search?q=india+monsoon+agriculture+kharif+rabi+economy&hl=en-IN&gl=IN&ceid=IN:en"],
     "Economy"),
]
